...
/* ----------------------------------------------------------------------------------------------- */
/*! \brief Структура для хранения внутренних данных функций хеширования семейства CRC. */
/* ----------------------------------------------------------------------------------------------- */
 typedef struct crc {
  /*! \brief Хеш-сумма */
  ak_uint64 sigma;
  /*! \brief Порождающий полином*/
  ak_uint64 seed;
  /*! \brief Маска*/
  ak_uint64 mask;
...
/* ----------------------------------------------------------------------------------------------- */
 typedef struct hash {
  ...
  /*! \brief Структура алгоритмов семейства CRC. */
    struct crc crcctx;
   } data;
 } *ak_hash;
...
/*! \brief Инициализация контекста функции бесключевого хеширования ГОСТ Р 34.11-2012 (Стрибог512). */
 ...
 /*! \brief Инициализация контекста функции бесключевого хеширования (CRC32). */
 dll_export int ak_hash_create_crc32( ak_hash );
 /*! \brief Инициализация контекста функции бесключевого хеширования (CRC64). */
...
/*! \brief Создание секретного ключа алгоритма выработки имитовставки HMAC на основе функции CRC32. */
dll_export int ak_hmac_create_crc32( ak_hmac );
/*! \brief Создание секретного ключа алгоритма выработки имитовставки HMAC на основе функции CRC64. */
dll_export int ak_hmac_create_crc64( ak_hmac );
